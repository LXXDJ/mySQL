...
-- 베이스테이블의 auto_increment가 적용되어 null 값을 넣어도 자동으로 increment된다.
...
/* VIEW로 DML 명령어 조작이 불가능한 경우 (사용된 서브쿼리에 따라 DML 조작이 불가능할 수 있다.)
...
-- OR REPLACE 옵션 : 테이블을 드롭하지 않고, 기존의 VIEW를 새로운 VIEW로 쉽게 다룰 수 있다.
